...
const helpText2 = [
    ...
    "Would recommend the fic Talent Night at the given url, mark it as incomplete, that its genres include shipping and humor, is a multi chapter fic, and its pairings include Danny and Ember ",
    "Another example is... ",
    ...
    "At minimum, you must name the fic, and give the URL so that I can figure out how to group the fic recommendations. Note the use of the back tick to contain spaces in titles. ",
...
const helpText3 = [
    "`!MrLancer author` is used to sign up an author as a prestigious member of our lists.",
    "You use it like so...",
...
client.on("message", function (message) {
    ...
    const prefix = strings.shift();

    if(prefix.toLocaleLowerCase() === '!oldman'){
        generateErrorReply(message, 'Who are you calling OLD man?');
    }
